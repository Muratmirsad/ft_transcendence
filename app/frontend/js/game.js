...
function gameLoop(roomName, isHost, isPlayerA) {
  ...
  const ws = new WebSocket(`wss://176.41.7.226/ws/game/${roomName}/`);
  ...
  const endGame = () => {
    ...
    fetch("https://176.41.7.226/game/end_game/", {
      method: "POST",
...
export function setupGame() {
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      fetch("https://176.41.7.226/game/create_room/", {
        method: "POST",
        headers: {
  ...
  document
    ...
    .addEventListener("submit", function (event) {
      ...
      console.log("Connected to server");
      fetch("https://176.41.7.226/game/join_room/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
